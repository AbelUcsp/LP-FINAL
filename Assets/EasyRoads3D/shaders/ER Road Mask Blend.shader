	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord32 = IN.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				...
				float2 uv_MetallicGlossMap2 = IN.ase_texcoord7.xy * _MetallicGlossMap2_ST.xy + _MetallicGlossMap2_ST.zw;
