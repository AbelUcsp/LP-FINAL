...
public class AudioController : MonoBehaviour
{
    ...
    // Para un fundido cruzado adecuado, los tonos de los clips deben coincidir, con un desplazamiento de octava entre graves y agudos. 


    [Tooltip("AdregadosPerfonalizados")] public AutoController _autoController;
    public InputManager _inputManager;
        ...
        private void StartSound()
        {
            ...
            _autoController = GetComponent<AutoController>();
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                float pitch = ULerp(lowPitchMin, lowPitchMax, _autoController.motorRPM/_autoController.MaxRPM);
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs((_inputManager._vertical > 0) ? _inputManager._vertical : 0);
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, _autoController.motorRPM/_autoController.MaxRPM);
