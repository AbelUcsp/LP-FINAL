...
public class Skidmarks : MonoBehaviour {
	...
	const int MAX_MARKS = 254; // Max number of marks total for everyone together
	...
	// Función llamada por la rueda que patina. Establece la intensidad de la sección de la marca de derrape, en el negro predeterminado
	...
	// Función llamada por la rueda que patina. Establece el color y la intensidad de la sección de skidmark. 
